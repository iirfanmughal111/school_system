...
@section('content')
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Manage Campuses</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                ...
                <li class="nav-item"><a href="#institute-list" class="nav-link show active" data-toggle="tab">Manage Campuses</a></li>
                <li class="nav-item"><a href="#new-institute" class="nav-link " data-toggle="tab">Create New Campus</a></li>
                                        ...
                                        <div class="list-icons">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-left">
                                                    ...
                                                    {{--Edit--}}
                                                    <a href="{{ route('campuses.edit', $u->id) }}" class="dropdown-item"><i class="icon-pencil"></i> Edit</a>
                                                    {{-- Delete --}}
