...
<div class="row">
    <div class="col-md-3 text-center">
        <div class="card">
            <div class="card-body">
                <img style="width: 90%; height:90%" src="{{ $sr->user->getAvatar() }}" alt="photo" class="rounded-circle">
                <br>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="basic-info">
                        <table class="table table-bordered">
                            ...
                            @endif
                            @if($sr->user->campus_id)
                            <tr>
                                
                                <td class="font-weight-bold">Campus</td>
                                <td>{{$sr->user->campus->name}} - <small>{{$sr->user->campus->address}} {{ $sr->user->campus->contact  }}</small></td>
                            </tr>
                        @endif
